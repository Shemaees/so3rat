...
<!-- Mirrored from doccure-html.dreamguystech.com/template/index-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 22 Mar 2021 19:28:15 GMT -->
<head>
    <meta charset="utf-8">
...
<div class="main-wrapper">
    ...
    <section class="section section-search-1">
        <div class="container">
            ...
            <header class="header">
                <nav class="navbar navbar-expand-lg header-nav nav-transparent">
                    ...
                    <ul class="nav header-navbar-rht">
                        ...
                        <li class="nav-item"><a class="nav-link header-login" href="login.html">login / Signup </a>
                        </li>
                    </ul>
                </nav>
            </header>
            ...
            <div class="row">
                <div class="col-md-6">
                    <img src="{{asset('front/assets/img/dr-slider.png')}}" class="img-fluid dr-img" alt="">
                </div>
                        ...
                        <div class="speicality-item text-center">
                            <div class="speicality-img">
                                <img src="assets/img/specialities/specialities-01.png" class="img-fluid"
                                     alt="Speciality"> <span><i class="fa fa-circle" aria-hidden="true"></i></span>
                            </div>
                            <p>Urology</p>
                        </div>
                        <!-- /Slider Item -->
...
<!-- Mirrored from doccure-html.dreamguystech.com/template/index-1.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 22 Mar 2021 19:28:16 GMT -->
</html>

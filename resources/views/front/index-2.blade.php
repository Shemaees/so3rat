    ...
    <!-- Home Banner -->
		<section class="section section-search-2">
			<div class="container">
				<div class="row">
					<div class="col-md-6">
						<img src="{{asset('front/assets/img/banner-1.png')}}" class="img-fluid search-img" alt="" >
					</div>
						...
						<div class="specialities-slider slider">
							...
							<div class="speicality-item text-center">
								<div class="speicality-img">
									<img src="{{asset('front/assets/img/specialities/specialities-01.png')}}" class="img-fluid" alt="Speciality">	<span><i class="fa fa-circle" aria-hidden="true"></i></span>
								</div>
								<p>Urology</p>
							</div>
							<!-- /Slider Item -->
							...
							<div class="speicality-item text-center">
								<div class="speicality-img">
									<img src="{{asset('front/assets/img/specialities/specialities-02.png')}}" class="img-fluid" alt="Speciality">	<span><i class="fa fa-circle" aria-hidden="true"></i></span>
								</div>
								<p>Neurology</p>
							</div>
							<!-- /Slider Item -->
							...
							<div class="speicality-item text-center">
								<div class="speicality-img">
									<img src="{{asset('front/assets/img/specialities/specialities-03.png')}}" class="img-fluid" alt="Speciality">	<span><i class="fa fa-circle" aria-hidden="true"></i></span>
								</div>
								<p>Orthopedic</p>
							</div>
							<!-- /Slider Item -->
							...
							<div class="speicality-item text-center">
								<div class="speicality-img">
									<img src="{{asset('front/assets/img/specialities/specialities-04.png')}}" class="img-fluid" alt="Speciality">	<span><i class="fa fa-circle" aria-hidden="true"></i></span>
								</div>
								<p>Cardiologist</p>
							</div>
							<!-- /Slider Item -->
							...
							<div class="speicality-item text-center">
								<div class="speicality-img">
									<img src="{{asset('front/assets/img/specialities/specialities-05.png')}}" class="img-fluid" alt="Speciality">	<span><i class="fa fa-circle" aria-hidden="true"></i></span>
								</div>
								<p>Dentist</p>
							</div>
							<!-- /Slider Item -->
			...
			<div class="container">
				...
				<div class="row">
					<div class="col-lg-3">
						<div class="category-box">
							<div class="category-image">
								<img src="{{asset('front/assets/img/category/1.png')}}" alt="">
							</div>
					...
					<div class="col-lg-3">
						<div class="category-box">
							<div class="category-image">
								<img src="{{asset('front/assets/img/category/2.png')}}" alt="">
							</div>
							<div class="category-content">
								<h4>Neurology</h4>
					...
					<div class="col-lg-3">
						<div class="category-box">
							<div class="category-image">
								<img src="{{asset('front/assets/img/category/3.png')}}" alt="">
							</div>
							<div class="category-content">
								<h4>Orthopedic</h4>
					...
					<div class="col-lg-3">
						<div class="category-box">
							<div class="category-image">
								<img src="{{asset('front/assets/img/category/4.png')}}" alt="">
							</div>
							<div class="category-content">
								<h4>Cardiologist</h4>
					...
					<div class="col-lg-3">
						<div class="category-box">
							<div class="category-image">
								<img src="{{asset('front/assets/img/category/5.png')}}" alt="">
							</div>
							<div class="category-content">
								<h4>Dentist</h4>

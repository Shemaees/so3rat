            ...
            <div class="swiper-container">
                <div class="swiper-wrapper">
                    <div class="swiper-slide">
                        <img src="{{asset('front/assets/img/slide1.jpg')}}" alt="">
                    </div>
                    <div class="swiper-slide">
                        <img src="{{asset('front/assets/img/slide2.jpg')}}" alt="">
                    </div>
                </div>
                <!-- Add Arrows -->
                        ...
                        <div class="row">
                            <div class="col-lg-4 mb-3">
                                <div class="card text-center doctor-book-card">
                                    <img src="{{asset('front/assets/img/doctors/doctor-07.jpg')}}" alt="" class="img-fluid">
                            ...
                            <div class="col-lg-4 mb-3">
                                <div class="card text-center doctor-book-card">
                                    <img src="{{asset('front/assets/img/img-pharmacy1.jpg')}}" alt="" class="img-fluid">
                                    <div class="doctor-book-card-content tile-card-content-1">
                                        <div>
                            ...
                            <div class="col-lg-4 mb-3">
                                <div class="card text-center doctor-book-card">
                                    <img src="{{asset('front/assets/img/lab-image.jpg')}}" alt="" class="img-fluid">
                                    <div class="doctor-book-card-content tile-card-content-1">
                                        <div>

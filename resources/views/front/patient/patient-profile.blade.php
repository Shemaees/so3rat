                        ...
                        <div class="card-body">
                            ...
                            <div class="patient-info">
                                <ul>
                                    ...
                                    <li>Age <span>{{ date_diff(new \DateTime($user->birthdate), new \DateTime())->format('%y Years') }},
                                        </span></li>
                                    <li>{{ __('front/patient.gender') }} : <span>{{ $user->gender }}</span></li>
                                ...
                                <ul class="nav nav-tabs nav-tabs-bottom nav-justified flex-wrap">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link" href="#pres"
                                            data-toggle="tab"><span>Prescription</span></a>
                                    </li>
                                    <li class="nav-item">
                                                        ...
                                                        @foreach ($requests as $item)
                                                            <tr>
                                                                    ...
                                                                    <h2 class="table-avatar">
                                                                        <a href="doctor-profile.html"
                                                                            ...
                                                                            <img class="avatar-img rounded-circle"
                                                                                src="{{asset($item->doctor->photo)}}"
                                                                                alt="User Image">
                                                                        </a>
                                                                        <a href="doctor-profile.html">Dr. {{$item->doctor->name}}
                                                                            <span>Dental</span></a>
                                                                    </h2>
                                                                </td>
                                                                <td>{{$item->created_at->format('Y-m-d')}} <span class="d-block text-info">{{$item->created_at->format('H:m')}}
                                                                        </span>
                                                                </td>
                                                                ...
                                                                <td><span
                                                                 ...
                                                                 <td class="text-right">
                                                                    <div class="table-action">
                                                                        ...
                                                                        <a href="{{route('appointments-status',[$item->id,'Rejected'])}}"
                                                                ...
                                                                <td><span
                                                                 ...
                                                                 <td class="text-right">
                                                                    <div class="table-action">
                                                                        <a href="{{route('appointments-status',[$item->id,'Accepted'])}}"
                                                                        class="btn btn-sm bg-success-light">
                                                                        <i class="far fa-edit"></i> Confirm
                                                                       </a>
                                                                        <a href="{{route('appointments-status',[$item->id,'Rejected'])}}"
                                                                        class="btn btn-sm bg-danger-light">
                                                                        <i class="far fa-trash-alt"></i> Cancel

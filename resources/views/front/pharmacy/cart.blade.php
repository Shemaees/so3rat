                        ...
                        <table class="table table-hover table-center mb-0">
                                ...
                                <td>
                                    <h2 class="table-avatar">
                                        <a href="product-description.html" class="avatar avatar-sm mr-2"><img
                                                class="avatar-img" src="assets/img/products/product.jpg"
                                                alt="User Image"></a>
                                    </h2>
                            ...
                            <tr>
                                <td>
                                    <h2 class="table-avatar">
                                        <a href="product-description.html" class="avatar avatar-sm mr-2"><img
                                                class="avatar-img" src="assets/img/products/product1.jpg"
                                                alt="User Image"></a>
                                    </h2>
                            ...
                            <tr>
                                <td>
                                    <h2 class="table-avatar">
                                        <a href="product-description.html" class="avatar avatar-sm mr-2"><img
                                                class="avatar-img" src="assets/img/products/product2.jpg"
                                                alt="User Image"></a>
                                    </h2>
                            ...
                            <tr>
                                <td>
                                    <h2 class="table-avatar">
                                        <a href="product-description.html" class="avatar avatar-sm mr-2"><img
                                                class="avatar-img" src="assets/img/products/product3.jpg"
                                                alt="User Image"></a>
                                    </h2>
                            ...
                            <tr>
                                <td>
                                    <h2 class="table-avatar">
                                        <a href="product-description.html" class="avatar avatar-sm mr-2"><img
                                                class="avatar-img" src="assets/img/products/product4.jpg"
                                                alt="User Image"></a>
                                    </h2>
                                        ...
                                        <ul class="booking-total-list">
                                            ...
                                            <li>
                                                <div class="clinic-booking pt-4">
                                                    <a class="apt-btn" href="product-checkout.html">Proceed to
                                                        checkout</a>
                                                </div>
                                            </li>
                                        </ul>

                                ...
                                <div class="clinic-details">
                                    <div class="clini-infos pt-3">
                                        ...
                                        <p class="doc-location mb-2 text-ellipse"><i
                                                class="fas fa-map-marker-alt mr-1"></i> 96 Red Hawk Road Cyrus, MN 56323
                                        </p>
                                        <p class="doc-location mb-2"><i class="fas fa-chevron-right mr-1"></i> Chemists,
                                            Surgical Equipment Dealer</p>

                                        <p class="doc-location mb-2"><i class="fas fa-chevron-right mr-1"></i> Opens at
                                            08.00 AM</p>
                                    ...
                                    <div class="col-md-6">
                                        <div class="clinic-content">
                                            ...
                                            <div class="clinic-details mb-0">
                                                <h5 class="clinic-direction"><i class="fas fa-map-marker-alt"></i> 96
                                                    Red Hawk Road Cyrus, MN 56323 <br><a href="javascript:void(0);">Get
                                                        Directions</a></h5>
                                                <ul>
                                                    <li>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="clinic-content">
                                            ...
                                            <div class="clinic-details mb-0">
                                                <p class="clinic-direction"><i class="fas fa-map-marker-alt"></i> 310
                                                    Cambridge Drive New River, AZ 85020 <br><a

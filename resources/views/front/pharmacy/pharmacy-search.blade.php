                            ...
                            <div class="doctor-widget">
                                <div class="doc-info-left">
                                    ...
                                    <div class="doc-info-cont">
                                        <h4 class="doc-name mb-2"><a href="pharmacy-details.html">Medlife Medical</a>
                                        </h4>
                                        ...
                                        <div class="clinic-details">
                                            <div class="clini-infos pt-3">
                                                ...
                                                <p class="doc-location mb-2 text-ellipse"><i
                                                        class="fas fa-map-marker-alt mr-1"></i> 96 Red Hawk Road Cyrus,
                                                    MN 56323 </p>
                        ...
                        <div class="card-body">
                            <div class="doctor-widget">
                                <div class="doc-info-left">
                                    ...
                                    <div class="doc-info-cont">
                                        <h4 class="doc-name mb-2"><a href="pharmacy-details.html">PharmaMed Medical</a>
                                        </h4>
                                        <div class="rating mb-2">
                                            <span class="badge badge-primary">4.0</span>
                                            <i class="fas fa-star filled"></i>
                                        ...
                                        <div class="clinic-details">
                                            <div class="clini-infos pt-3">
                                                ...
                                                <p class="doc-location mb-2"><i class="fas fa-phone-volume mr-1"></i>
                                                    913-631-2538</p>
                                                <p class="doc-location mb-2 text-ellipse"><i
                                                        class="fas fa-map-marker-alt mr-1"></i> 3830 Poe Lane Kansas
                                                    City, KS 66216 </p>
                                                <p class="doc-location mb-2"><i class="fas fa-chevron-right mr-1"></i>
                                                    Chemists, Surgical Equipment Dealer</p>
                        ...
                        <div class="card-body">
                            <div class="doctor-widget">
                                <div class="doc-info-left">
                                    ...
                                    <div class="doc-info-cont">
                                        <h4 class="doc-name mb-2"><a href="pharmacy-details.html">The Pill Club
                                                Medical</a></h4>
                                        <div class="rating mb-2">
                                            <span class="badge badge-primary">4.0</span>
                                            <i class="fas fa-star filled"></i>
                                        ...
                                        <div class="clinic-details">
                                            <div class="clini-infos pt-3">
                                                ...
                                                <p class="doc-location mb-2"><i class="fas fa-phone-volume mr-1"></i>
                                                    816-270-2336</p>
                                                <p class="doc-location mb-2 text-ellipse"><i
                                                        class="fas fa-map-marker-alt mr-1"></i> 3849 Nutter Street

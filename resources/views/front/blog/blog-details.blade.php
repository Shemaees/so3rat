                                    ...
                                    <div class="about-author-img">
                                        <div class="author-img-wrap">
                                            <a href="doctor-profile.html"><img class="img-fluid rounded-circle" alt=""
                                                                               src="{{asset('front/assets/img/doctors/doctor-thumb-02.jpg')}}"></a>
                                        </div>
                                    </div>
                                ...
                                <ul class="comments-list">
                                        ...
                                        <ul class="comments-list reply">
                                            ...
                                            <li>
                                                <div class="comment">
                                                    <div class="comment-author">
                                                        <img class="avatar" alt=""
                                                             src="{{asset('front/assets/img/patients/patient6.jpg')}}">
                                                    </div>
                                                    <div class="comment-block">
                                                            <span class="comment-by">
                                    ...
                                    <li>
                                        <div class="comment">
                                            <div class="comment-author">
                                                <img class="avatar" alt=""
                                                     src="{{asset('front/assets/img/patients/patient7.jpg')}}">
                                            </div>
                                            <div class="comment-block">
                                                    <span class="comment-by">
                            ...
                            <ul class="latest-posts">
                                <li>
                                    <div class="post-thumb">
                                        <a href="blog-details.html">
                                            <img class="img-fluid"
                                                 src="{{asset('front/assets/img/blog/blog-thumb-01.jpg')}}" alt="">
                                        </a>
                                    </div>
                                    <div class="post-info">
                                        <h4>
                                ...
                                <li>
                                    <div class="post-thumb">
                                        <a href="blog-details.html">
                                            <img class="img-fluid"
                                                 src="{{asset('front/assets/img/blog/blog-thumb-02.jpg')}}" alt="">
                                        </a>
                                    </div>
                                    <div class="post-info">
                                        <h4>
                                ...
                                <li>
                                    <div class="post-thumb">
                                        <a href="blog-details.html">
                                            <img class="img-fluid"
                                                 src="{{asset('front/assets/img/blog/blog-thumb-03.jpg')}}" alt="">
                                        </a>
                                    </div>
                                    <div class="post-info">
                                        <h4>
                                ...
                                <li>
                                    <div class="post-thumb">
                                        <a href="blog-details.html">
                                            <img class="img-fluid"
                                                 src="{{asset('front/assets/img/blog/blog-thumb-04.jpg')}}" alt="">
                                        </a>
                                    </div>
                                    <div class="post-info">
                                        <h4>
                                ...
                                <li>
                                    <div class="post-thumb">
                                        <a href="blog-details.html">
                                            <img class="img-fluid"
                                                 src="{{asset('front/assets/img/blog/blog-thumb-05.jpg')}}" alt="">
                                        </a>
                                    </div>
                                    <div class="post-info">
                                        <h4>

                            ...
                            <div class="doctor-widget">
                                <div class="doc-info-left">
                                    ...
                                    <div class="doc-info-cont">
                                        ...
                                        <p><span class="text-muted">Manufactured By </span> Hamdard (Wakf) Laboratories
                                        </p>
                                        ...
                                        <div class="col-md-9">
                                            ...
                                            <div class="widget about-widget">
                                                ...
                                                <p>Safi syrup is best for purifying the blood. As it contains herbal
                                                    extracts it can cure indigestion, constipation, nose bleeds and acne
                                                    boils. It helps in the removal of the toxins from the blood. It
                                                    improves the complexion and gives you a healthy life</p>
                                            </div>
                                            <!-- /About Details -->
                                                        ...
                                                        <li>
                                                            ...
                                                            <div class="experience-content">
                                                                <div class="timeline-content">
                                                                    <p>Safi syrup is known for its best purifying syrup
                                                                        for blood.</p>
                                                                </div>
                                                            </div>
                                                        </li>
                                            ...
                                            <div class="widget about-widget">
                                                ...
                                                <p>Store this syrup at room temperature protected from sunlight, heat,
                                                    and moisture. Keep away from reaching out of children and pets.
                                                    Ensure that the unused medicine is disposed of properly.</p>
                                            </div>
                                            <!-- /About Details -->
                                            <!-- About Details -->
                                            <div class="widget about-widget">
                                                ...
                                                <p>Shake the bottle before its use. This syrup can be taken with or
                                                    without food. The quantity consumed should not be lesser or greater
                                                    than the prescribed one.</p>
                                            </div>
                                            <!-- /About Details -->
                                            ...
                                            <div class="widget about-widget mb-3">
                                                ...
                                                <p class="mb-0">Syrup has to be disposed of properly after 3 years from
                                                    manufactured date and it is not recommended to use after the
                                                    date.</p>
                                            </div>
                                            <!-- /About Details -->
                                        </div>
                    ...
                    <div class="card search-filter">
                        <div class="card-body">
                            <div class="clini-infos mt-0">
                                <h2>$19 <b class="text-lg strike">$45</b> <span
                                        class="text-lg text-success"><b>10% off</b></span></h2>
                            </div>

                                            ...
                                            <div class="dash-widget dct-border-rht" style="direction: ltr;">
                                                <div class="circle-bar circle-bar1">
                                                    <div class="circle-graph1" data-percent="75">
                                                        <img src="{{asset('front/assets/img/icon-01.png')}}"
                                            ...
                                            <div class="dash-widget dct-border-rht" style="direction: ltr;">
                                                <div class="circle-bar circle-bar2">
                                                    <div class="circle-graph2" data-percent="65">
                                                        <img src="{{asset('front/assets/img/icon-02.png')}}"
                                                             class="img-fluid" alt="Patient">
                                                    </div>
                                                </div>
                                                <div class="dash-widget-info">
                                            ...
                                            <div class="dash-widget " style="direction: ltr;">
                                                <div class="circle-bar circle-bar3">
                                                    <div class="circle-graph3" data-percent="50">
                                                        <img src="{{asset('front/assets/img/icon-03.png')}}"
                                                             class="img-fluid" alt="Patient">
                                                    </div>
                                                </div>
                                                <div class="dash-widget-info">
                                                            ...
                                                            <td>
                                                                <h2 class="table-avatar">
                                                                    <a href="patient-profile.html"
                                                                       class="avatar avatar-sm mr-2"><img
                                                                            class="avatar-img rounded-circle"
                                                                            src="{{asset('front/assets/img/patients/patient1.jpg')}}"
                                                                            alt="User Image"></a>
                                                            ...
                                                            <td>
                                                                <h2 class="table-avatar">
                                                                    <a href="patient-profile.html"
                                                                       class="avatar avatar-sm mr-2"><img
                                                                            class="avatar-img rounded-circle"
                                                                            src="{{asset('front/assets/img/patients/patient10.jpg')}}"
                                                                            alt="User Image"></a>
                                                            ...
                                                            <td>
                                                                <h2 class="table-avatar">
                                                                    <a href="patient-profile.html"
                                                                       class="avatar avatar-sm mr-2"><img
                                                                            class="avatar-img rounded-circle"
                                                                            src="{{asset('front/assets/img/patients/patient11.jpg')}}"
                                                                            alt="User Image"></a>

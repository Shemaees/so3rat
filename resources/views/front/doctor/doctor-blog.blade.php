                        ...
                        <div class="row mb-5">
                            <div class="col">
                                <ul class="nav nav-tabs nav-tabs-solid">
                                    <li class="nav-item">
                                        <a class="nav-link active" href="doctor-blog.html">Acitive Blog</a>
                                    </li>
                                    <li class="nav-item">
                        ...
                        <div class="row blog-grid-row">
                            ...
                            <div class="col-md-6 col-xl-4 col-sm-12">
                                ...
                                <div class="blog grid-blog">
                                    ...
                                    <div class="row pt-3">
                                        <div class="col"><a href="edit-blog.html" class="text-success"><i
                                                    class="far fa-edit"></i> Edit</a></div>

                                        <div class="col text-right"><a href="javascript:void(0);" class="text-danger"
                                                                       data-toggle="modal"
                            ...
                            <div class="col-md-6 col-xl-4 col-sm-12">
                                ...
                                <div class="blog grid-blog">
                                    ...
                                    <div class="blog-content">
                                        ...
                                        <h3 class="blog-title"><a href="blog-details.html">Benefits of consulting with
                            ...
                            <div class="col-md-6 col-xl-4 col-sm-12">
                                ...
                                <div class="blog grid-blog">
                                    <div class="blog-image">
                                        <a href="blog-details.html"><img class="img-fluid"
                                                                         src="{{asset('front/assets/img/blog/blog-05.jpg')}}"
                                                                         alt="Post Image"></a>
                                    </div>
                                    <div class="blog-content">
                                        <ul class="entry-meta meta-item">
                                            <li>
                                                <div class="post-author">
                                                    <a href="doctor-profile.html"><img
                                                            src="{{asset('front/assets/img/doctors/doctor-thumb-05.jpg')}}"
                            ...
                            <div class="col-md-6 col-xl-4 col-sm-12">
                                ...
                                <div class="blog grid-blog">
                                    <div class="blog-image">
                                        <a href="blog-details.html"><img class="img-fluid"
                                                                         src="{{asset('front/assets/img/blog/blog-06.jpg')}}"
                                                                         alt="Post Image"></a>
                                    </div>
                                    <div class="blog-content">
                                        <ul class="entry-meta meta-item">
                                            <li>
                                                <div class="post-author">
                                                    <a href="doctor-profile.html"><img
                                                            src="{{asset('front/assets/img/doctors/doctor-thumb-06.jpg')}}"
                            ...
                            <div class="col-md-6 col-xl-4 col-sm-12">
                                ...
                                <div class="blog grid-blog">
                                    <div class="blog-image">
                                        <a href="blog-details.html"><img class="img-fluid"
                                                                         src="{{asset('front/assets/img/blog/blog-07.jpg')}}"
                                                                         alt="Post Image"></a>
                                    </div>
                                    <div class="blog-content">
                                        <ul class="entry-meta meta-item">
                                            <li>
                                                <div class="post-author">
                                                    <a href="doctor-profile.html"><img
                                                            src="{{asset('front/assets/img/doctors/doctor-thumb-07.jpg')}}"
                            ...
                            <div class="col-md-6 col-xl-4 col-sm-12">
                                ...
                                <div class="blog grid-blog">
                                    <div class="blog-image">
                                        <a href="blog-details.html"><img class="img-fluid"
                                                                         src="{{asset('front/assets/img/blog/blog-08.jpg')}}"
                                                                         alt="Post Image"></a>
                                    </div>
                                    <div class="blog-content">
                                        <ul class="entry-meta meta-item">
                                            <li>
                                                <div class="post-author">
                                                    <a href="doctor-profile.html"><img
                                                            src="{{asset('front/assets/img/doctors/doctor-thumb-08.jpg')}}"
                                                            alt="Post Author"> <span>Dr. Paul Richard </span></a>
                                                </div>
                                            </li>
                                            <li><i class="far fa-clock"></i> 25 Nov 2019</li>
                                        </ul>
                                        <h3 class="blog-title"><a href="blog-details.html">Simple steps to visit your
                                                doctor today</a></h3>
                                        <p class="mb-0">Lorem ipsum dolor sit amet, consectetur em adipiscing elit, sed
                                            do eiusmod tempor.</p>
                                    </div>
                            ...
                            <div class="col-md-6 col-xl-4 col-sm-12">
                                ...
                                <div class="blog grid-blog">
                                    <div class="blog-image">
                                        <a href="blog-details.html"><img class="img-fluid"
                                                                         src="{{asset('front/assets/img/blog/blog-09.jpg')}}"
                                                                         alt="Post Image"></a>
                                    </div>
                                    <div class="blog-content">
                                        <ul class="entry-meta meta-item">
                                            <li>
                                                <div class="post-author">
                                                    <a href="doctor-profile.html"><img
                                                            src="{{asset('front/assets/img/doctors/doctor-thumb-09.jpg')}}"
                            ...
                            <div class="col-md-6 col-xl-4 col-sm-12">
                                ...
                                <div class="blog grid-blog">
                                    <div class="blog-image">
                                        <a href="blog-details.html"><img class="img-fluid"
                                                                         src="{{asset('front/assets/img/blog/blog-10.jpg')}}"
                                                                         alt="Post Image"></a>
                                    </div>
                                    <div class="blog-content">
                                        <ul class="entry-meta meta-item">
                                            <li>
                                                <div class="post-author">
                                                    <a href="doctor-profile.html"><img
                                                            src="{{asset('front/assets/img/doctors/doctor-thumb-10.jpg')}}"
                                                            alt="Post Author"> <span>Dr. Olga Barlow</span></a>
                                                </div>
                                            </li>
                                            <li><i class="far fa-clock"></i> 23 Nov 2019</li>
                                        </ul>
                                        <h3 class="blog-title"><a href="blog-details.html">Online Doctoral Programs</a>
                                        </h3>
                                        <p class="mb-0">Lorem ipsum dolor sit amet, consectetur em adipiscing elit, sed
                                            do eiusmod tempor.</p>
                                    </div>

...
<!-- Mirrored from doccure-html.dreamguystech.com/template/doctor-pending-blog.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 22 Mar 2021 19:29:05 GMT -->
            ...
            <div class="main-menu-wrapper">
                ...
                <ul class="main-nav">
                    ...
                    <li class="has-submenu active">
                        ...
                        <ul class="submenu">
                            ...
                            <li class="has-submenu active">
                                ...
                                <ul class="submenu">
                                    <li class="active"><a href="doctor-blog.html">Blog</a></li>
                    ...
                    <li class="has-submenu">
                        ...
                        <ul class="submenu">
                            <li><a href="pharmacy-index.html">Pharmacy Home</a></li>
                        ...
                        <div class="row mb-5">
                            <div class="col">
                                <ul class="nav nav-tabs nav-tabs-solid">
                                    ...
                                    <li class="nav-item">
                                        <a class="nav-link active" href="doctor-pending-blog.html">Pending Blog</a>
                                    </li>
                                </ul>
                            </div>
                            <div class="col-auto">

                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body card-dashboard">
                                        <table
                                            ...
                                            <tbody>
                                            @foreach($upcomingOrders as  $up_order)
                                                <tr data-entry-id="{{ $up_order->id }}">
                                                    <td>
                                                    ...
                                                    <td>
                                                        <div class="btn-group mr-1 mb-1">
                                                            ...
                                                            <div class="dropdown-menu">
                                                                <a href="{{route('dashboard.orders.show',$up_order->id)}}" class="dropdown-item">
                                                                    <i class="ft-eye">
                                                                    </i>
                                                                    {{__('global.show')}}
                                                                </a>
                                        ...
                                        {{ $upcomingOrders->links('vendor.pagination.bootstrap-4') }}
                                    </div>
                                </div>
                            </div>
                        </div>

                                        ...
                                        <form action="{{ route("users.store") }}" method="POST"
                                            ...
                                            <div class="form-row mb-2">
                                                <div class="col-md-5">
                                                    ...
                                                    <label class="custom-file-label"
                                                           for="photo">{{__('global.photo')}}</label>
                                                    @error('photo')
                                            ...
                                            <div class="form-body">
                                                <h4 class="form-section">
                                                    <i class="ft-home"></i> {{__('dashboard/user.user_data')}}
                                                </h4>
                                                <div
                                                    class="form-row pt-2 {{ $errors->has('name') ? 'has-error' : '' }}">
                                                    <div class="col-md-6">
                                                        <label
                                                            for="firstname">{{__('dashboard/user.firstname')}}</label>
                                                ...
                                                <div
                                                    class="form-row pt-2 {{ $errors->has('email') ? 'has-error' : '' }}">
                                                    <div class="col-md-6">
                                                ...
                                                <div class="form-row pt-2">
                                                    <div class="col-md-6">
                                                        <label
                                                            for="projectinput1">{{__('global.login_password')}}</label>
                                                        <input type="password"
                                                               class="form-control"
                                                               placeholder=""
                                                    ...
                                                    <div class="col-md-6">
                                                        ...
                                                        <div class="custom-control custom-radio custom-control">
                                                            <input type="radio" class="custom-control-input"
                                                                   id="customRadio" name="gender" value="0">
                                                            <label class="custom-control-label"
                                                                   for="customRadio">{{__('global.male')}}</label>
                                                        </div>
                                                        <div class="custom-control custom-radio custom-control-inline">
                                                            <input type="radio" class="custom-control-input"
                                                                   id="customRadio2" name="gender" value="1">
                                                            <label class="custom-control-label"
                                                ...
                                                <div class="form-row d-none " id="subjects">
                                                    <div class="col-md-6 pt-2 ">
                                                        <label for="subjects">
                                                            {{__('dashboard/subject.title')}}
                                                        </label>
                                                    ...
                                                    <div class="col-md-6 pt-2">
                                                        <label for="class">
                                                            {{__('dashboard/subject.class')}}
                                                        </label>
                                                        <select name="classes[]" id="classes" class="form-control"
                                                                multiple="multiple">
                                                            @foreach($classes as $class)
                                                                <option
                                                                    value="{{ $class->id }}">{{ $class->grade->name . '>' . $class->name }}</option>
                                                            @endforeach
                                                        </select>
                                                        @error("classes")
                                                        <span class="text-danger">{{$message}}</span>
    ...
    <script>
        $(document).ready(function () {
            $('#grades').on('change', function () {
                ...
                $.ajax({
                    type: 'get',
                    url: "{{ route('dashboard.getClassRoomsByGradeId') }}",
                    data: {'id': $(this).val()},
                    success: function (data) {
                        $('#class_room').parent().removeClass('d-none');
                        var html = '';

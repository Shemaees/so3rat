                    ...
                    <div class="row breadcrumbs-top">
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="#x`">
                                        الطلاب
                                    </a>
                                </li>
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                ...
                                <div class="card-content collapse show">
                                    <div class="card-body">
                                        <form class="form"
                                              action="{{route('admin.users.savelesson', [Auth::user()->id, $course])}}"
                                              method="POST"
                                            ...
                                            <div class="form-body">
                                                <h4 class="form-section"><i class="ft-home"></i> الكورسات </h4>
                                                <div class="row">
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1">الكورس</label>
                                                            <select name="course" class="form-control select2">
                                                                <optgroup label="من فضلك اختار الكورس">
                                                                    @isset($courses)
                                                                        @foreach($courses as $course)
                                                                            <option
                                                                                @if($lesson->course_id == $course->id) {{'selected'}} @endif value="{{$course->id}}">
                                                                                {{$course->name}}
                                                                            </option>
                                                                        @endforeach
                                                                    @endisset
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group">
                                                            <label for="projectinput1">عدد المحاضرات المتاحة</label>
                                                            <input type="number"
                                                                   class="form-control"
                                                                   placeholder=""

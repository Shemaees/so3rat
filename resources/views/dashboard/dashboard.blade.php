...
@section('vendor')
    ...
    <script src="{{asset('assets/dashboard/vendors/js/extensions/datedropper.min.js')}}"
            type="text/javascript"></script>
    <script src="{{asset('assets/dashboard/vendors/js/extensions/timedropper.min.js')}}"
            type="text/javascript"></script>
...
@section('script')
    <script src="{{asset('assets/dashboard/js/scripts/extensions/date-time-dropper.js')}}"
            type="text/javascript"></script>
@endsection

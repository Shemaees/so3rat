<div class="main-menu menu-fixed menu-light menu-accordion menu-shadow " data-scroll-to-active="true">
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            {{-- <a class="menu-item" href="{{route("user.users")}}" data-i18n="nav.dash.all"> --}}
            {{-- عرض الكل --}}
            {{-- </a> --}}
            {{-- </li> --}}
            {{-- <li class="{{request()->routeIs('user.users.activated') ? 'active' : ''}}"> --}}
            {{-- <a class="menu-item" href="{{route("user.users.activated")}}" data-i18n="nav.dash.active"> --}}
            {{-- المفعلين --}}
            {{-- </a> --}}
            {{-- </li> --}}
            {{-- <li class="{{request()->routeIs('user.users.deactivated') ? 'active' : ''}}"> --}}
            {{-- <a class="menu-item" href="{{route("user.users.deactivated")}}" data-i18n="nav.dash.deactive"> --}}
            {{-- الغير مفعلين --}}
            {{-- </a> --}}
            {{-- </li> --}}
            {{-- <li class="{{request()->routeIs('user.users.blocked') ? 'active' : ''}}"> --}}
            {{-- <a class="menu-item" href="{{route("user.users.blocked")}}" data-i18n="nav.dash.block"> --}}
            {{-- المحجوبين --}}
            {{-- </a> --}}
            {{-- </li> --}}
            {{-- <li class="{{request()->routeIs('user.users.create') ? 'active' : ''}}"> --}}
            {{-- <a class="menu-item" href="{{route("user.users.create")}}" data-i18n="nav.dash.crypto"> --}}
            {{-- أضافة طالب جديد --}}
            {{-- </a> --}}
            {{-- </li> --}}
            {{-- </ul> --}}
            ...
            {{-- </a> --}}
            {{-- <ul class="menu-content"> --}}
            {{-- <li class="{{request()->routeIs('user.message.all') ? 'active' : ''}}"> --}}
            {{-- <a class="menu-item" href="{{route('user.message.all')}}" data-i18n="nav.dash.ecommerce"> --}}
            {{-- عرض الكل --}}
            {{-- </a> --}}
            {{-- </li> --}}
            {{-- <li class=" {{request()->routeIs('user.message') ? 'active' : ''}}"> --}}
            {{-- <a class="menu-item" href="{{route('user.message')}}" data-i18n="nav.dash.crypto"> --}}
            {{-- إضافة رسالة جديد --}}
            {{-- </a> --}}
            {{-- </li> --}}
            {{-- </ul> --}}
            ...
            {{-- </li> --}}
            {{-- <li class=" nav-item"> --}}
            {{-- <a href="https://pixinvent.com/modern-user-clean-bootstrap-4-dashboard-html-template/documentation"><i --}}

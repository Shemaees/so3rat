    ...
    <div class="navbar-wrapper">
        ...
        <div class="navbar-container content">
            <div class="collapse navbar-collapse" id="navbar-mobile">
                ...
                <ul class="nav navbar-nav float-right" dir="ltr">
                    <li class="dropdown dropdown-user nav-item" dir="rtl">
                        <a class="dropdown-toggle nav-link dropdown-user-link" href="#" data-toggle="dropdown">
                            <span class="mr-1">مرحبا {{ auth('admins')->check() ? auth('admins')->user()->name : 'admin'}}
                                <span class="user-name text-bold-700"></span>
                            </span>
                            <span class="avatar avatar-online">
                                <img style="height: 35px;" src="{{asset('assets/dashboard/images/avatar.jpg')}}"
                                     alt="avatar">
                                <i></i>
                            </span>
                        </a>

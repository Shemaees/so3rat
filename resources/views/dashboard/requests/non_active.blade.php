                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            @foreach($users as $user)
                                                                @if($non_active_request->user_id == $user->id)
                                                                    {{__($user->name)}}
                                                                @endif
                                                            @endforeach
                                                        </td>
                                                        <td >
                                                            @foreach($subscriptions as $subscription)
                                                                @if($non_active_request->subscription_id == $subscription->id)
                                                                    {{__($subscription->name)}}
                                                                @endif
                                                            @endforeach
                                                        </td>
                                                        <td> {{$non_active_request->visited_at}} </td>
                                                        <td>
                                                            @if($non_active_request->user_request == '1' )
                                                        ...
                                                        <td>
                                                            <div class="btn-group mr-1 mb-1">
                                                                ...
                                                                <div class="dropdown-menu">
                                                                    <a href="{{route('dashboard.requests.show',$non_active_request->id)}}" class="dropdown-item">
                                                                        <i class="ft-eye"></i>
                                                                        {{__('global.show')}}
                                                                    </a>
                                                                    <a href="{{route('dashboard.requests.change_status',$non_active_request->id)}}"
                                                                       ...
                                                                       onclick="return confirm('{{__('dashboard/user.request_change_status')}}');">
                                                                        @if($non_active_request->user_request == 0)

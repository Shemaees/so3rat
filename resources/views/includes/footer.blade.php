                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="footer-widget footer-contact">
                        ...
                        <div class="footer-contact-info">
                            <p> <i class="fas fa-map-marker-alt"></i> Jeddah, Saudia Arabia </p>
                            <p> <i class="fas fa-phone-alt"></i> 051234568</p>
                            <p class="mb-0"> <i class="fas fa-envelope"></i> Soarat@example.com
                            </p>
                        </div>
                    </div>
                    <!-- /Footer Widget -->
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-6">
                        <div class="copyright-text">
                            <p class="mb-0">&copy; 2021 Soarat. All rights reserved.</p>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-6">
                        <!-- Copyright Menu -->
